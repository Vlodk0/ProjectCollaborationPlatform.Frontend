...
@Component({
  selector: 'collabro-project-scheduler',
  templateUrl: './project-scheduler-dialog.component.html',
  styleUrl: './project-scheduler-dialog.component.scss'
})
export class ProjectSchedulerDialogComponent implements OnDestroy {
  ...
  constructor(private readonly projectService: ProjectsService,
              ...
              private readonly dialogRef: MatDialogRef<ProjectSchedulerDialogComponent>,
